...
<?php foreach ($images as $value): ?>
                        ...
                        <li>
                            <a class="img-fancy " href="<?php echo base_url() . 'uploads/' . $value->name; ?>" data-fancybox-group="thumb">
                                <img src="<?php echo base_url() . 'uploads/' . $value->thumb; ?>" class="thumbnail"/>
                            </a>
                            <div class="caption">delete|edit</div>
